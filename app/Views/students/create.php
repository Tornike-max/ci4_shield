...
<div class="max-w-3xl w-full mx-auto p-6 bg-white shadow-md rounded-lg">
    <h2 class="text-2xl w-full font-semibold mb-6">Create Student</h2>
    <form class="w-full" action="<?= base_url('students/store') ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>
        ...
        <div class="mb-4">
            ...
            <img src="" alt="Profile Image" width="100" class="mt-2">
        </div>
